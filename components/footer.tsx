    ...
    <footer className="bg-gradient-to-b from-gray-50 to-gray-100 border-t border-gray-200 mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8 mb-8">
          {/* Company Info */}
          <div>
            <h3 className="font-bold text-2xl mb-4 text-orange-600">Swirly</h3>
            <p className="text-gray-600 text-sm leading-relaxed">
              Premium food delivery service bringing delicious meals to your doorstep
            </p>
            <p className="text-gray-500 text-xs mt-4">© 2026 Swirly Food Delivery. All rights reserved.</p>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex gap-2 items-start">
                ...
                <a href="mailto:info@swirly.com" className="text-gray-600 hover:text-orange-600 transition">
                  info@swirly.com
                </a>
              </div>
              <div className="flex gap-2 items-start">
        ...
        <div className="border-t border-gray-200 pt-8 text-center text-sm text-gray-600">
          <p>Swirly © 2026 - Delivering happiness, one meal at a time</p>
        </div>
      </div>
    </footer>
  )
